...
void idCommonLocal::Frame()
{
	try
	{
		...
		{
			idSIMD::InitProcessor( "QUIP", com_forceGenericSIMD.GetBool() ); // foresthale 2014-05-21: changed doom to phaeton
			idDmapSIMD::InitProcessor( "QUIP-dmap", com_forceGenericSIMD.GetBool() ); // foresthale 2014-05-21: changed doom to phaeton-dmap
